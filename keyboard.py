...
def setup():
    ...
    servo_dict["11"] = GPIO(11,FREQ)
    servo_dict["13"] = GPIO(13,FREQ)
    servo_dict["15"] = GPIO(15,FREQ)
    servo_dict["37"] = GPIO(37,FREQ)
    servo_dict["16"] = GPIO(16,FREQ)
    servo_dict["18"] = GPIO(18,FREQ)
    servo_dict["22"] = GPIO(22,FREQ)
    servo_dict["26"] = GPIO(26,FREQ)
